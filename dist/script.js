...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('.active').setAttr('data-text', 'value').removeAttr('data-text').toggleAttr('data-text', 'test').toggleAttr('data-text');
console.log(Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('button').mapAttr('disabled', 'data-test'));
